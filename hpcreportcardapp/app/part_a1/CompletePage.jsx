...
import { getPartA2Route, isSecondaryStage, getAfterRegistrationRoute } from "../../utils/stageRouter";
          ...
          <View style={styles.buttonCol}>
            <GemButton
              onPress={async () => {
                ...
                // Grade 9-12 students should use S4 full form; route to S4 Part A1 if they land here
                if (isSecondaryStage(cls)) {
                  router.push('/part_a1_s4/GeneralInformation');
                  return;
                }
                // Otherwise use stage-aware Part A2 routing
