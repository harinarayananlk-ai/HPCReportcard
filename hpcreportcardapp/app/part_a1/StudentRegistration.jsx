...
import { getAfterRegistrationRoute, isSecondaryStage } from "../../utils/stageRouter";
...
export default function TeacherRegistrationPage() {
  ...
  // Auto-redirect Grade 9–12: skip this screen, go straight to S4 form
  useEffect(() => {
    if (studentClass && isSecondaryStage(studentClass)) {
      router.replace('/part_a1_s4/GeneralInformation');
    }
  }, [studentClass]);
  ...
  const handleNext = async () => {
    ...
    // Smart routing: Grade 9-12 → S4 full form; others → ParentRegistration → CompletePage
    router.push(getAfterRegistrationRoute(studentClass));
  };
